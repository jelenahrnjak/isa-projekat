...
export class EditBoatBasicInfoComponent implements OnInit {
  ...
  submit(){
    ...
    if(this.boat.name == "" || this.boat.type == "" || this.boat.pricePerDay == "" || this.boat.description == "" || this.boat.cancellationConditions == "" || this.boat.maximumPeople == "" || this.boat.length == "" || this.boat.engineNumber == "" || this.boat.enginePower == "" || this.boat.maxSpeed == "" || this.boat.capacity == ""
    ...
    else if(letters.test(this.boat.pricePerDay) || letters.test(this.boat.length) || letters.test(this.boat.engineNumber) || letters.test(this.boat.enginePower) || letters.test(this.boat.maxSpeed) || letters.test(this.boat.capacity) || letters.test(this.boat.address.latitude) || letters.test(this.boat.address.longitude)){
      Swal.fire({
        icon: 'error',
        title: 'Oops...',
