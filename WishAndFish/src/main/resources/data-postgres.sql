...
INSERT INTO USERS(id, deleted, email, enabled, last_password_reset_date, loyalty_category, name, password, phone_number, points, surname, address_id)
	VALUES (55, false, 'jelenahrnjak99@gmail.com', true, null, 2, 'Jelena', 'flasaflasica123', '0607363683',151, 'Hrnjak', 100);
INSERT INTO USERS(id, deleted, email, enabled, last_password_reset_date, loyalty_category, name, password, phone_number, points, surname, address_id)
	VALUES (50, false, 'stojic.kris@gmail.com', true, null, 1, 'Kristina', 'Nikola1234.', '0643515864', 90, 'Stojić', 200);
INSERT INTO USERS(id, deleted, email, enabled, last_password_reset_date, loyalty_category, name, password, phone_number, points, surname, address_id)
	VALUES (35, false, 'dusansisarica@gmail.com', true, null, 0, 'Dušan', 'dusanglup', '0617294870', 0, 'Šišarica', 300);

INSERT INTO USER_ROLE(user_id, role_id) VALUES (55, 5);
