...
public class CottageControllerTest {
    ...
    public void testGetCottageById() throws Exception {
        mockMvc.perform(get(URL_PREFIX + "/findCottage/" + 111L)).andExpect(status().isOk())
    ...
    public void testSaveCottage() throws Exception {
        ...
        cottage.setAddress(new AddressDTO("ulica","123",
                "21000",15.12,16.15,
                "grad","drzava"));
        cottage.setPrice(150.5);
        cottage.setOwnerEmail("stojic.kris@gmail.com");
        cottage.setCoverImage("slika");
    ...
    public void testUpdateCottage() throws Exception {
        ...
        cottage.setAddress(new AddressDTO("ulica","123",
                "21000",15.12,16.15,
                "grad","drzava"));
        cottage.setPricePerDay(150.5);
        cottage.setBedsPerRoom(4);
    ...
    public void testDeleteBoat() throws Exception {
        this.mockMvc.perform(delete(URL_PREFIX + "/deleteCottage/" + 111l)).andExpect(status().isOk());
    }
